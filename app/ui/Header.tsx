        ...
        <ul
          ...
          <li className='max-lg:border-b max-lg:py-3 px-3'>
            <a href='javascript:void(0)'
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Inicio</a>
          </li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Categorias</a>
          </li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Contactanos</a>
          </li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Sobre Nosotros</a>
          </li>
        </ul>
      </div>
